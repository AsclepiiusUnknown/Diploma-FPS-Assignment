...
namespace FPS
{
    ...
    public class FpsCustomNetworked : MonoBehaviour
    {
        #region |VARIABLES
        ...
        private void Update()
        {
            ...
            if (_player.GetButtonDown("Sprint"))
            {
        ...
        private void FixedUpdate()
        {
            ...
            if (_player.GetButtonUp("Jump") && _moveDir.y > 0) _moveDir.y *= jumpCut;
        ...
        {
            // Read input
            float horizontal = _player.GetAxis("Horizontal");
